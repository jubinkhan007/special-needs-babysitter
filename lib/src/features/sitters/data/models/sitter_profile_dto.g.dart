...
SitterProfileDataDto _$SitterProfileDataDtoFromJson(
  ...
  profile: SitterProfileDto.fromJson(json['profile'] as Map<String, dynamic>),
);
...
SitterProfileDto _$SitterProfileDtoFromJson(
  Map<String, dynamic> json,
) => SitterProfileDto(
  ...
  jobTypesAccepted: (json['jobTypesAccepted'] as Map<String, dynamic>?)?.map(
