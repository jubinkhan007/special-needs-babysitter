    ...
    InterceptorsWrapper(
      onRequest: (options, handler) async {
        ...
        if (session == null) {
          ...
          debugPrint(
            'DEBUG: Interceptor - AccessToken: ${session.accessToken}',
          );
        ...
        debugPrint(
          'DEBUG: Interceptor - Request: ${options.method} ${options.uri}',
        );
...
final parentProfileRepositoryProvider = Provider<ParentProfileRepository>((
  ref,
) {
