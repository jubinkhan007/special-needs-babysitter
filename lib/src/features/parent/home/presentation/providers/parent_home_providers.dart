...
final parentHomeBookingsProvider = FutureProvider<List<Booking>>((ref) async {
  final repository = ref.watch(bookingsRepositoryProvider);
  return repository.getBookings();
});

final parentHomeSittersProvider = FutureProvider<List<SitterListItemModel>>((
  ref,
) async {
  ...
  return repository.fetchSitters(latitude: latitude, longitude: longitude);
});
