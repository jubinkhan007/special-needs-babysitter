...
class _EditProfileDetailsDialogState extends State<EditProfileDetailsDialog> {
  ...
  void initState() {
    ...
    _petTypes = {'Dog': false, 'Cat': false, 'Bird': false};
    ...
    _languages = {'Spanish': false, 'French': false, 'English': false};
  ...
  Future<void> _handleSave() async {
    if (_formKey.currentState!.validate()) {
      ...
      final selectedPetTypes = _petTypes.entries
          .where((e) => e.value)
          .map((e) => e.key)
          .toList();
                ...
                child: Column(
                  ...
                  children: [
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: _image != null
                                ...
                                : (widget.initialDetails.user.avatarUrl != null
                                      ? DecorationImage(
                                          image: NetworkImage(
                                            widget
                                                .initialDetails
                    ...
                    if (_hasPets) ...[
                      ...
                      _buildInputContainer(
                        child: TextFormField(
                          ...
                          style: const TextStyle(color: AppColors.buttonDark),
                          decoration: _inputDecoration('Number of Pets'),
                      ...
                      Wrap(
                        ...
                        children: [
                          ...
                          ActionChip(
                            ...
                            onPressed: () => _showAddDialog('Pet Type', (val) {
                              setState(() {
                                _petTypes[val] = true;
                              });
                            }),
                    ...
                    _buildCheckboxTile(
                      ...
                      _hasSecondLanguage,
                      (v) => setState(() => _hasSecondLanguage = v ?? false),
                    ),
                    if (_hasSecondLanguage) ...[
                      ...
                      _buildInputContainer(
                        child: TextFormField(
                          ...
                          style: const TextStyle(color: AppColors.buttonDark),
                          decoration: _inputDecoration('Number of Languages'),
                          keyboardType: TextInputType.number,
                          inputFormatters: [
                            FilteringTextInputFormatter.digitsOnly,
                          ],
                      ...
                      Wrap(
                        ...
                        children: [
                          ...
                          ActionChip(
                            ...
                            onPressed: () => _showAddDialog('Language', (val) {
                              setState(() {
                                _languages[val] = true;
                              });
                            }),
