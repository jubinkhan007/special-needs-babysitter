...
import 'package:babysitter_app/src/features/bookings/presentation/models/active_booking_details_ui_model.dart';
    ...
    return BookingSurfaceCard(
      child: Column(
        ...
        children: [
          ...
          if (uiModel.skillTags.isNotEmpty) ...[
            const SizedBox(height: 18),
            // 3. Skills Section
            Wrap(
              spacing: 8,
              runSpacing: 8,
              children: uiModel.skillTags
