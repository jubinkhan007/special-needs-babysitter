...
class SavedSitterCard extends StatelessWidget {
  ...
  const SavedSitterCard({super.key, required this.sitter});
          ...
          Stack(
            children: [
              ClipRRect(
                ...
                child: Image.asset(
                  sitter.avatarUrl,
                  height: HomeDesignTokens.savedSitterImageHeight, // 120
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'Nashville, TN', // Expanded format as per requirements
                          maxLines: 1,
                          overflow: TextOverflow.ellipsis,
                          style: const TextStyle(
                            fontSize: 11,
